...
# 定义点 w=10 requires_grad=True  dtlosspe=torch.float32
...
for i in range(1, 101):
    ...
    # 梯度清零 w.grad.zero_()   因为默认梯度会累加
    # (第一次的时候), 还没有计算梯度, w.grad = None, 要做非空判断 因为None.zero会报错
    ...
    # 梯度更新 w.data = w.data - 0.01 * w.grad
    # print(f'梯度值为: {w.grad}')
